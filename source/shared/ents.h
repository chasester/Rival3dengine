...
//controlers are defined in halo.h, so they can be used by the scriptmgr

//struct scriptctrl; 


//struct prefab {
//	vector<scriptCtrl> ctrls;
//};
...
//angelo sauer ents
enum { ENT_PLAYER = 0, ENT_CAMERA, ENT_BOUNCE, ENT_INANIMATE, ENT_BULLETENT };//angelo physics
//angelo sauer ents
