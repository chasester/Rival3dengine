...
////VAR(nodeselradius, 0, 2, 10); //obsolete: may change to nodeselbuffer (so it will add to the radius of the object to have a slightly larger radius for ease of use. may also add a miniselection radius;
//
//
...
//}
//
//void worldeditor::_setnodesnap(bool v) { nodeselsnap = v; }
//void worldeditor::_setnodeediting(bool v) { nodecanedit = v; }
//void worldeditor::_setnodecanedit(bool v) {}
//bool worldeditor::_getnodesnape() { return nodeselsnap; }
//bool worldeditor::_getnodeediting() { return nodeediting; }
//bool worldeditor::_getnodecanedit() { return nodecanedit; }
//
//VARF(nodeediting, 0, 0, 1, { if (worldeditor::noedit()) worldeditor::_setnodeediting(nodeediting); } ); //change to a toggle
//
//
////VAR(attachradius, 1, 100, 1000); obsolete
//
//VARF(nodeselsnap, 0, 0, 1, { if (worldeditor::nodenoedit()) worldeditor::_setnodesnap(nodeselsnap); } );
...
//
//
////VAR(showentradius, 0, 1, 1); obsolete
//
////VAR(entitysurf, 0, 0, 1); obsolete
//
////ICOMMAND(nodeaddsel, "", (), // Obsolete?
////{
////   if(!worldeditor::noedit())
////    {
////		worldeditor::nodemoving
...
//});
//
//void worldeditor::_nodemoving(int *n)
//{
//	if (*n >= 0)
//	{
//		if (!*n || nodehover < 0 || nonodeedit()) nodemoving = 0;
//		else
//		{
...
//}
//
//COMMANDN(nodemoving, worldeditor::_nodemoving, "b");
//
//
//
...
//		{
//			if(nodenoedit() || !nodehaveselect() || !nodemoving) return;
//
//			float r = 0, c = 0;
